...
const Summary = () => {
     return (
          <div className="relative flex justify-center bg-gradient-to-tr from-transparent from-50% to-blue-900  shadow-2xl md:p-5 w-1/2 md:min-w-[50%] md:w-[60%] min-h-64 md:min-h-96 lg:min-h-96 lg:w-[50%] rounded-lg rounded-tr-none">
            ...
            <p className="md:p-12 p-5">                         I am a front-end web developer with a passion for creating clean and efficient code, user experience, and responsive design. I value continuous learning alongside a team where I can contribute my skills and knowledge, and grow with creativity and innovation.
</p>
          </div>
     );
};
